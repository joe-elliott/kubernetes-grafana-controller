...
var grafanadatasourcesResource = schema.GroupVersionResource{Group: "grafana.k8s.io", Version: "v1alpha1", Resource: "grafanadatasources"}

var grafanadatasourcesKind = schema.GroupVersionKind{Group: "grafana.k8s.io", Version: "v1alpha1", Kind: "GrafanaDataSource"}
...
func (c *FakeGrafanaDataSources) Get(name string, options v1.GetOptions) (result *v1alpha1.GrafanaDataSource, err error) {
	obj, err := c.Fake.
...
func (c *FakeGrafanaDataSources) List(opts v1.ListOptions) (result *v1alpha1.GrafanaDataSourceList, err error) {
	obj, err := c.Fake.
...
func (c *FakeGrafanaDataSources) Watch(opts v1.ListOptions) (watch.Interface, error) {
	return c.Fake.
...
func (c *FakeGrafanaDataSources) Create(grafanaDataSource *v1alpha1.GrafanaDataSource) (result *v1alpha1.GrafanaDataSource, err error) {
	obj, err := c.Fake.
...
func (c *FakeGrafanaDataSources) Update(grafanaDataSource *v1alpha1.GrafanaDataSource) (result *v1alpha1.GrafanaDataSource, err error) {
	obj, err := c.Fake.
...
func (c *FakeGrafanaDataSources) UpdateStatus(grafanaDataSource *v1alpha1.GrafanaDataSource) (*v1alpha1.GrafanaDataSource, error) {
	obj, err := c.Fake.
...
func (c *FakeGrafanaDataSources) Delete(name string, options *v1.DeleteOptions) error {
	_, err := c.Fake.
...
func (c *FakeGrafanaDataSources) DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error {
	action := testing.NewDeleteCollectionAction(grafanadatasourcesResource, c.ns, listOptions)
...
func (c *FakeGrafanaDataSources) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.GrafanaDataSource, err error) {
	obj, err := c.Fake.
